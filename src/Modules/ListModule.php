...
use Repack\Texy;
use Repack\Texy\BlockParser;
use Repack\Texy\HtmlElement;
use Repack\Texy\Modifier;
...
final class ListModule extends Texy\Module
{
    ...
    public function patternList(BlockParser $parser, array $matches)
    {
        ...
        // event listener
        $this->texy->invokeHandlers('afterList', array($parser, $el, $mod));
    ...
    public function patternDefList(BlockParser $parser, array $matches)
    {
        ...
        // event listener
        $texy->invokeHandlers('afterDefinitionList', array($parser, $el, $mod));
